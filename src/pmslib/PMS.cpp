    ...
    default:
      ...
      else if (_index == _frameLen + 2 + 1)
      {
        ...
        if (_calculatedChecksum == _checksum)
        {
          ...
          _data->PARTICLE_0_3UM = makeWord(_payload[12], _payload[13]);
          _data->PARTICLE_0_5UM = makeWord(_payload[14], _payload[15]);
          _data->PARTICLE_1_0UM = makeWord(_payload[16], _payload[17]);
          _data->PARTICLE_2_5UM = makeWord(_payload[18], _payload[19]);
          _data->PARTICLE_5_0UM = makeWord(_payload[20], _payload[21]);
          _data->PARTICLE_10_0UM = makeWord(_payload[21], _payload[23]);
        }
